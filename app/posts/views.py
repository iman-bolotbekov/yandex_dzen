...
from .serializers import PostSerializer, CommentSerializer, StatusPostSerializer, StatusTypeSerializer
...
class StatusTypeRetrieve(generics.ListCreateAPIView):
    queryset = StatusType.objects.all()
    serializer_class = StatusTypeSerializer
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, ]

    def get_queryset(self):
        return super().get_queryset().filter(post_id=self.kwargs.get('id'))
